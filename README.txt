...
somewhere else: the people, the trees, the sky, and the gun.
  ...
  js/                   the game — js/voxel.js is the newest of it: a
                          ...
                          can take some of it away, drawn by js/mapgeo.js
                          and opened by anything that fires a round
...
they close the tab.
  ...
  the smoke test         1325 checks, no install and no browser
...
1325 checks. Every one of them earns its place by having caught something
